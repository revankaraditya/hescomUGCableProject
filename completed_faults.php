    ...
    <div class="col-xs-12 col-lg-12 col-md-12 ">
        <div class="box box-info">
            <div class="box-header">
                <h3 class="box-title">Completed Faults List for
                ...
                <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        if ($login_query_result['UTNO'] == 2) {
                            $query_ug = "select fr.*,c.fname,u.name from fault_records fr inner join secondary_fault_category c on fr.cid=c.cid inner join users u on fr.uid=u.uid where fr.status=0 and fr.uid=" . $uid . "";
                        } else {
                            $query_ug = "select fr.*,c.fname,u.name from fault_records fr inner join secondary_fault_category c on fr.cid=c.cid inner join users u on fr.uid=u.uid where fr.status=0;";
                        }
                        ...
                        foreach ($query_result_ug as $row) {
                            ...
                            $fault_str .= "<div class='clearfix'></div>
																...
																<!-- /.modal -->
																<!-- Edit modal -->";
                            $fault_str .= "<button type='button' class='btn btn-warning' id='ch_status' data-toggle='modal' data-target='#ch_status" . $row['FID'] . "'> <i class='fa fa-info-circle'></i></button>
