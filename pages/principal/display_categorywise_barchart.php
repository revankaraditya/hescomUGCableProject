<?php
	...
	//include_once('get_dept_overall_stat.php');
		...
		$Categorywise_count_query1 = "SELECT count(*) AS cat_count FROM fault_records fm WHERE CID IN (1,2,3)";
		$Categorywise_count1 = db_one($Categorywise_count_query1);	
		
		$Categorywise_count_query2 = "SELECT count(*) AS cat_count FROM fault_records fm WHERE CID IN (4,5,6,7)";
		$Categorywise_count2 = db_one($Categorywise_count_query2);	
		
		$Categorywise_count_query3 = "SELECT count(*) AS cat_count FROM fault_records fm WHERE CID IN (8,9,10,11)";
...
//-------------
    ...
    //-------------
	 var areaChartData = {
      labels: ["11KV Cable", "LT Cable", "RMU Fault"],
      datasets: [
        {
          label: "Electronics",
          ...
          data: [<?php  echo $Categorywise_count1['cat_count'].','.$Categorywise_count2['cat_count'].','.$Categorywise_count3['cat_count'];?>]
        }
      ]
    };
